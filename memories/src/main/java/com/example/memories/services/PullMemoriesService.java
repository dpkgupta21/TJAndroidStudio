...
public class PullMemoriesService extends IntentService {
    ...
    private void fetchMemories() {
        ...
        String fetchMemoriesUrl = "Constants.URL_MEMORIES_FETCH_ALL" + journey.getIdOnServer() + "/memories?api_key=" + TJPreferences.getApiKey(this);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (i = 0; i < responseArray.length(); i++) {
                                ...
                                switch (Integer.parseInt(memoryType)) {
                                    ...
                                    case HelpMe.TYPE_CHECKIN:
                                        ...
                                        buddys = memory.getJSONObject("memory").getString("buddies");
                                        buddyIds = buddys == null ? null : Arrays.asList(buddys.split(","));
